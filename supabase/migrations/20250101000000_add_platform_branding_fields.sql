...
COMMENT ON COLUMN platform_config.company_name_long IS 'Nombre largo: "ZEN México"';
COMMENT ON COLUMN platform_config.commercial_name IS 'Nombre comercial: "Zen Studio"';
COMMENT ON COLUMN platform_config.commercial_name_short IS 'Nombre corto para UI: "ZEN" (usado en AppHeader)';
COMMENT ON COLUMN platform_config.domain IS 'Dominio principal: "www.zenn.mx"';
