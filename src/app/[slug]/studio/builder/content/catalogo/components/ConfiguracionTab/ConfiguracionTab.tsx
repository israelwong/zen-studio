...
import { obtenerConfiguracionCatalogo, actualizarConfiguracionCatalogo } from '@/lib/actions/studio/builder/catalogo/configuracion.actions';
import { toast } from 'sonner';

interface ConfiguracionCatalogo {
...
export function ConfiguracionTab({ studioSlug }: ConfiguracionTabProps) {
    ...
    const [configuracion, setConfiguracion] = useState<ConfiguracionCatalogo>({
        visibleEnMenu: true,
    ...
    useEffect(() => {
        const cargarConfiguracion = async () => {
            try {
                setLoading(true);
                const result = await obtenerConfiguracionCatalogo(studioSlug);
    ...
    const actualizarConfiguracion = async (nuevaConfiguracion: Partial<ConfiguracionCatalogo>) => {
        try {
            setSaving(true);
            const configuracionActualizada = { ...configuracion, ...nuevaConfiguracion };

            const result = await actualizarConfiguracionCatalogo(studioSlug, configuracionActualizada);
        ...
        <div className="space-y-6">
            ...
            <ZenCard>
                <ZenCardHeader>
                    ...
                    <ZenCardDescription>
                        Controla si el catálogo es visible en el menú de navegación del sitio
                    </ZenCardDescription>
                </ZenCardHeader>
                <ZenCardContent>
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-zinc-400">
                                El catálogo aparecerá en el menú principal del sitio
                            </p>
                        </div>
                        <Switch
            ...
            <ZenCard>
                <ZenCardHeader>
                    ...
                    <ZenCardDescription>
                        Define si los visitantes necesitan registrarse para ver el catálogo
                    </ZenCardDescription>
                </ZenCardHeader>
                <ZenCardContent>
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-zinc-400">
                                Solo las personas que llenen un lead form podrán ver el catálogo
                            </p>
                        </div>
                        <Switch
            ...
            <ZenCard>
                <ZenCardHeader>
                    ...
                    <ZenCardDescription>
                        Selecciona cómo se mostrará el catálogo en el sitio
                    </ZenCardDescription>
                </ZenCardHeader>
                <ZenCardContent>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-zinc-400">
                                    El catálogo se muestra en formato de lista vertical
                                </p>
                            </div>
                            <Switch
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-1">
                                ...
                                <p className="text-xs text-zinc-400">
                                    El catálogo se muestra en formato de cuadrícula
                                </p>
                            </div>
                            <Switch
                ...
                <ZenCardContent className="pt-6">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-zinc-400">
                                Esta configuración afecta cómo se muestra el catálogo en el sitio web público.
