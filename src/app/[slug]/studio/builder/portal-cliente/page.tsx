...
export default function PortalClientePage() {
    ...
    const previewData = builderData ? {
        ...
        // Para ProfileContent (sección portal cliente)
            ...
            <ZenCard variant="default" padding="none">
                <ZenCardHeader className="border-b border-zinc-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <ZenCardTitle>Portal Cliente</ZenCardTitle>
                            <ZenCardDescription>
                                Configura el portal de acceso para tus clientes
                            </ZenCardDescription>
                        </div>
                    </div>
                </ZenCardHeader>
                ...
                <ZenCardContent className="p-6">
                    <div className="space-y-6">
                        ...
                        {/* Portal Cliente Wrapper */}
                        <PortalClienteWrapper studioSlug={studioSlug} />
                    </div>
                </ZenCardContent>
            </ZenCard>
        </SectionLayout>
