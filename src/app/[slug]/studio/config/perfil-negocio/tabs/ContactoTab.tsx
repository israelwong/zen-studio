...
import { ScheduleAndZonesCard } from '@/app/[slug]/studio/business/identity/components/ScheduleAndZonesCard';
...
export function ContactoTab({ builderData, loading, studioSlug, onDataChange }: ContactoTabProps) {
    if (loading) {
        return (
