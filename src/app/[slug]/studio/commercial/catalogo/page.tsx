...
import { SeccionEditorModal, SeccionFormData, CategoriaEditorModal, CategoriaFormData, ItemEditorModal, ItemFormData, UtilidadForm, CatalogoTabSkeleton } from './components';
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        <ZenButton
                            variant="outline"
                            onClick={() => router.push(`/${studioSlug}/studio/commercial/catalogo/paquetes`)}
