...
import { usePromiseCierreLogic } from './components/usePromiseCierreLogic';
...
import { ContratoDigitalCard } from './components/ContratoDigitalCard';
import { ContractTemplateSimpleSelectorModal } from './components/contratos/ContractTemplateSimpleSelectorModal';
import { ContractPreviewForPromiseModal } from './components/contratos/ContractPreviewForPromiseModal';
import { PagoInicialCard } from './components/PagoInicialCard';
...
export default function PromiseCierrePage() {
  ...
  // Mostrar skeleton si el contexto está cargando o si estamos cargando la cotización
  if (contextLoading || !contextPromiseData || loadingCotizacion) {
