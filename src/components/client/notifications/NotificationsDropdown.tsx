...
export function NotificationsDropdown({ studioSlug, contactId }: NotificationsDropdownProps) {
    ...
    <ZenDropdownMenu open={open} onOpenChange={setOpen}>
      <ZenDropdownMenuTrigger asChild>
        <ZenButton
          ...
          size="icon"
          className={cn(
            "relative rounded-full text-zinc-400 hover:text-zinc-200 transition-all",
