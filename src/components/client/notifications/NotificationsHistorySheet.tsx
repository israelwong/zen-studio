...
import { useClientNotificationsHistory } from '@/hooks/useClientNotificationsHistory';
import { buildRoute } from '@/lib/notifications/client/utils';
...
export function NotificationsHistorySheet({
  ...
  const handleNotificationClick = async (notification: studio_client_notifications) => {
...
function HistoryNotificationItem({
  ...
  notification: studio_client_notifications;
  open: boolean;
  onNotificationClick: (notification: studio_client_notifications) => void;
}) {
