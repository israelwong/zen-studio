                                ...
                                {categoria.servicios
                                  ...
                                  .map((servicio, servicioIndex) => {
                                    ...
                                    return (
                                      <div
                                        key={servicio.id}
                                        className={`flex items-center justify-between py-3 px-2 pl-6 ${
                                          servicioIndex > 0 ? 'border-t border-zinc-700/30' : ''
                                        } hover:bg-zinc-700/20 transition-colors ${
                                          cantidad > 0 ? 'bg-emerald-900/10 border-l-2 border-emerald-500/50' : ''
                                        }`}
                                      >
                                        {/* Nivel 3: Servicio */}
                                          ...
                                          <div className="flex items-center gap-1 w-16 justify-center">
                                            ...
                                            <span
                                              className={`w-6 text-center text-sm font-medium ${
                                                cantidad > 0 ? 'text-emerald-400' : 'text-white'
                                              }`}
                                            >
                                              {cantidad}
                                            </span>
